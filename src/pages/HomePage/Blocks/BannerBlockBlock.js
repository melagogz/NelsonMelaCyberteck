...
import leftCTAImgBg from './../../../images/discovery_Bg_small.jpg'
import rightCTAImgBg from  './../../../images/free_1-1_tutorial_bg.jpg'
...
<section>
         <div className="uk-grid uk-grid-collapse" data-uk-grid>
                  <div className="uk-width-1-2@s">
                    ...
                    style={{ backgroundImage: `url(${leftCTAImgBg})`,
                  ...
                  style={{ backgroundImage: `url(${rightCTAImgBg})`,
                  backgroundRepeat: 'no-repeat',
                  backgroundSize: 'cover',
                  paddingBottom: '67px',
                  height: 'auto',
