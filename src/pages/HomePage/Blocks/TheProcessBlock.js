...
import dirBg from './../../../images/connect.png'
import procBg from './../../../images/processBg.jpg'
                ...
                <div className="">
                     <div className="uk-width-1-1 uk-padding@s">
                      ...
                      <p className="subText  uk-text-center">We organised a few easy steps for you to sign up and join our tech savvy group</p>
                          ...
                          <div className="uk-grid  uk-child-width-1-4@s uk-margin-large-top " 
                          
                          style={{ backgroundImage: `url(${dirBg})`,
                ...
                <div className="">
                     <div className="uk-width-1-1 uk-padding@s">
                      ...
                      <p className="subText  uk-text-center">We organised a few easy steps for you to sign up and join our tech savvy group</p>
                          ...
                          style={{ backgroundImage: `url(${procBg})`,
                          backgroundRepeat: 'no-repeat',
                          backgroundPosition: 'cover',
