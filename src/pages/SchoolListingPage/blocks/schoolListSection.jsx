...
function a11yProps(index) {
    return {
        ...
        style: { ...{ margin: '0 5px', borderTopRightRadius: '3px',borderTopLeftRadius: '3px',backgroundColor: '#73d56e', color: 'white', minWidth: '13%', padding: 10, fontSize: 14, fontWeight: 600 } }
    };
}
